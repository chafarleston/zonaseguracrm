...
} from "./chunk-Q5Z7ZAE3.js";
import {
  createContextScope,
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-CK4DOJGJ.js";
import {
  Primitive
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React3.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React3.useCallback((option) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime2.jsx)(React3.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectContentFragment = React3.forwardRef((props, forwardedRef) => {
  ...
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) ? (0, import_jsx_runtime2.jsx)("option", { value: "" }) : null,
