          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-green-900 truncate">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="hidden sm:inline-flex gap-2 border-green-600 text-green-700 hover:bg-green-50 text-sm"
              >
